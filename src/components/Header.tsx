        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              className="text-xs font-bold px-3 py-2 rounded-xl bg-gradient-to-r from-cyan-500/15 to-emerald-500/15 border border-cyan-500/30 text-cyan-300 hover:text-white hover:border-cyan-400 transition-all inline-flex items-center gap-1.5 shadow-sm"
            >
