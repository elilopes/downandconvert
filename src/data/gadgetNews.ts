...
export const mockedGadgetNews: GadgetNewsItem[] = [
  {
    ...
    categoryLabel: {
      PT: "Ciência & Hardware",
      EN: "Science & Hardware",
      RU: "Наука и оборудование",
      HI: "विज्ञान और हार्डवेयर",
      KO: "과학 및 하드웨어"
    },
    author: "TecMundo • TechViva Flipboard",
    pubDate: "2026-09-03T19:37:00Z",
    link: "https://www.tecmundo.com.br/ciencia/415663-computacao-neuromorfica-como-funcionam-os-chips-inspirados-no-cerebro.htm",
    title: {
      PT: "Computação neuromórfica: como funcionam os chips inspirados no cérebro",
      EN: "Neuromorphic computing: how brain-inspired chips work",
      RU: "Нейроморфные вычисления: как работают чипы, вдохновленные мозгом",
      HI: "न्यूरोमॉर्फिक कंप्यूटिंग: मस्तिष्क से प्रेरित चिप्स कैसे काम करते हैं",
      KO: "뉴로모픽 컴퓨팅: 뇌를 모방한 인공지능 칩의 작동 원리"
    },
    subtitle: {
      PT: "Arquitetura inspirada em redes neurais biológicas revoluciona eficiência energética de IA",
      EN: "Biological neural network architecture revolutionizes AI energy efficiency",
      RU: "Архитектура, вдохновленная биологическими нейросетями, меняет энергоэффективность ИИ",
      HI: "जैविक तंत्रिका नेटवर्क से प्रेरित वास्तुकला एआई ऊर्जा दक्षता में क्रांति लाती है",
      KO: "생물학적 신경망에서 영감을 얻은 구조로 차세대 초저전력 AI 연산 구현"
    },
    lead: {
      PT: "A computação neuromórfica é uma abordagem para projetar computadores inspirada na maneira como o cérebro processa informações. Em vez de circuitos estáticos convencionais, utiliza neurônios e sinapses de silício com altíssima eficiência energética.",
      EN: "Neuromorphic computing is an approach to computer design inspired by how the brain processes information, utilizing silicon neurons and synapses with extreme energy efficiency.",
      RU: "Нейроморфные вычисления вдохновлены принципами работы человеческого мозга, используя кремниевые нейроны и синапсы с высочайшей энергоэффективностью.",
      HI: "न्यूरोमॉर्फिक कंप्यूटिंग मस्तिष्क द्वारा सूचना को संसाधित करने के तरीके से प्रेरित है, जो सिलिकॉन न्यूरॉन्स और सिनेप्स का उपयोग करता है।",
      KO: "뉴로모픽 컴퓨팅은 인간의 뇌가 정보를 처리하는 방식을 모방하여 실리콘 뉴런과 시냅스로 극도의 에너지 효율을 달성하는 차세대 기술입니다."
    }
  },
  {
    id: "flipboard-oculos-foco-automatico",
    category: "inventions",
    categoryLabel: {
      PT: "Invenção & Óptica",
      EN: "Invention & Optics",
      RU: "Изобретения и оптика",
      HI: "आविष्कार और प्रकाशिकी",
      KO: "발명 및 광학"
    },
    author: "Veja Tecnologia • TechViva Flipboard",
    pubDate: "2026-09-02T16:20:00Z",
    link: "https://veja.abril.com.br/tecnologia/empresa-finlandesa-desenvolve-oculos-que-ajustam-o-foco-em-tempo-real/",
    title: {
      PT: "Empresa finlandesa desenvolve óculos inteligentes que ajustam o foco em tempo real",
      EN: "Finnish company develops smart glasses that adjust focus in real time",
      RU: "Финская компания разработала умные очки с мгновенной автофокусировкой",
      HI: "फिनिश कंपनी ने स्मार्ट ग्लास विकसित किए जो वास्तविक समय में फोकस समायोजित करते हैं",
      KO: "핀란드 스타트업, 실시간으로 초점을 자동 조절하는 스마트 안경 개발"
    },
    subtitle: {
      PT: "Lentes líquidas com rastreamento ocular eliminam a necessidade de multifocais fixos",
      EN: "Liquid lenses with eye tracking eliminate the need for fixed multifocals",
      RU: "Жидкие линзы с отслеживанием взгляда устраняют потребность в традиционных мультифокальных стеклах",
      HI: "आई-ट्रैकिंग वाले लिक्विड लेंस निश्चित मल्टीफोकल की आवश्यकता को समाप्त करते हैं",
      KO: "안구 추적 센서와 액체 렌즈가 결합되어 거리 변화에 따라 초점을 실시간 보정"
    },
    lead: {
      PT: "Equipados com micro-atuadores e sensores de rastreamento de olhar, os óculos inteligentes recalculam a curvatura da lente de forma instantânea, permitindo ver perfeitamente de perto e de longe sem distorções visuais.",
      EN: "Equipped with micro-actuators and eye-tracking sensors, these smart glasses instantly adjust lens curvature, allowing clear vision near and far without distortion.",
      RU: "Оснащенные микроприводами и сенсорами взгляда, умные очки мгновенно меняют кривизну линз, обеспечивая четкое зрение на любых расстояниях.",
      HI: "माइक्रो-एक्चुएटर और आई-ट्रैकिंग सेंसर से लैस, ये स्मार्ट ग्लास लेंस की वक्रता को तुरंत समायोजित करते हैं।",
      KO: "미세 액추에이터와 안구 추적 센서가 시선 거리를 감지하여 액체 렌즈의 곡률을 즉각 변형시켜 어떤 거리든 선명한 시야를 제공합니다."
    }
  },
  {
    id: "flipboard-ia-doenca-cardiaca",
    category: "discoveries",
    categoryLabel: {
      PT: "Medicina & IA",
      EN: "Medicine & AI",
    ...
    author: "UOL Tilt • TechViva Flipboard",
    pubDate: "2026-09-02T14:40:00Z",
    link: "https://www.uol.com.br/tilt/colunas/iagora/2026/09/02/como-nova-ia-supera-olho-de-medico-e-detecta-doenca-no-coracao-em-2-segundos.htm",
    title: {
      PT: "IA supera olho médico e detecta doença cardíaca em menos de 2 segundos",
      EN: "AI outperforms doctors and detects heart disease in under 2 seconds",
      RU: "ИИ превзошел врачей и диагностирует болезни сердца менее чем за 2 секунды",
      HI: "एआई ने डॉक्टरों को पीछे छोड़ा और 2 सेकंड से भी कम समय में हृदय रोग का पता लगाया",
      KO: "인공지능, 2초 만에 심장 질환 진단… 의료진 육안 판독 능가"
    },
    subtitle: {
      PT: "Algoritmo treinado com ecocardiogramas alcança precisão de ponta e agiliza emergências",
      EN: "Algorithm trained on echocardiograms achieves breakthrough accuracy in emergency care",
      RU: "Алгоритм на основе эхокардиограмм достигает рекордной точности в неотложной помощи",
      HI: "इकोकार्डियोग्राम पर प्रशिक्षित एल्गोरिदम आपातकालीन देखभाल में उच्च सटीकता प्राप्त करता है",
      KO: "방대한 심장초음파 데이터를 학습한 AI가 응급실 골든타임 내 초정밀 진단 지원"
    },
    lead: {
      PT: "Nova ferramenta de inteligência artificial analisa exames de imagem em velocidade relâmpago e identifica anomalias estruturais no coração, auxiliando equipes médicas no diagnóstico precoce de infartos e insuficiências.",
      EN: "New artificial intelligence tool analyzes imaging scans at lightning speed and identifies structural cardiac anomalies, aiding early diagnosis of heart conditions.",
      RU: "Новый инструмент искусственного интеллекта мгновенно анализирует медицинские снимки и выявляет структурные аномалии сердца на ранних стадиях.",
      HI: "नया कृत्रिम बुद्धिमत्ता उपकरण बिजली की गति से इमेजिंग स्कैन का विश्लेषण करता है और हृदय की समस्याओं की पहचान करता है।",
      KO: "첨단 의료 인공지능 모델이 심장 영상 검사를 단 2초 만에 분석하여 미세한 심장 이상 징후와 심부전 가능성을 조기 포착합니다."
    }
  },
  {
